...
def free_surface_params(cfg: Config, grid: Grid):
    ...
    Dh = cfg.nut_max / cfg.Sc_t + cfg.disp_horiz + wave + cfg.shear_disp * umax * dx
...
class NereidSolver:
    ...
    def _dispersion_tensor(self):
        ...
        Dh = cfg.D_mol + nut / cfg.Sc_t + cfg.disp_horiz
        ...
        Db = cfg.bath_disp_gain * (cfg.disp_horiz + nut / cfg.Sc_t) \
    ...
    def _dt(self):
        ...
        nut_m = self.nut.max()
        wave = cfg.wave_disp_gain * math.pi * cfg.Hs ** 2 / max(cfg.Tw, 1e-3)
        Dh = nut_m / cfg.Sc_t + cfg.disp_horiz + wave + cfg.shear_disp * uh * dx
...
def main(argv=None):
    ...
    if args.selftest or args.validate or args.gridconv:
